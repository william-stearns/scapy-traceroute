...
__copyright__ = 'Copyright 2018-2025, William Stearns'
...
def ip_addr_obj(raw_addr):
	...
	try:
		if sys.version_info > (3, 0):
			...
			raw_addr_string = unicode(raw_addr)	# pylint: disable=undefined-variable
...
def load_json_from_file(json_filename: str):
...
def write_object(filename: str, generic_object):
...
def cache_file(parent_cache_dir: str, ip_addr: str) -> str:
